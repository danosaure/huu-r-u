...
export type UserPreferencesValueType<T extends UserPreferencesOptionType> =
  UserPreferencesOptionsType[T];

export type PersistentUserPreferencesType = UserPreferencesOptionsType & {
  id: "me";
};

export type PersistentUserPreferencesValueType<
  T extends UserPreferencesOptionType
> = PersistentUserPreferencesType[T];
